    ...
    <v-row>
      ...
      <v-col cols="12">
        <v-card :style="{ borderRadius: '30px' }">
          <v-card-title style="background: rgba(232, 38, 70, 0.7);">
            <h2 class="text-h7 mt-2 mb-2 text-center">Data Pengajuan Training</h2>
            <v-row justify="center">
                <v-btn 
                    ...
                    <i class="bx bxs-customize" style="margin-right: 4px;"></i>
                    List Pengajuan Training
                </v-btn>
            </v-row>
            <v-spacer></v-spacer>
            <!-- <v-text-field
          ...
          <!-- Responsive Table -->
          <div class="table-responsive pa-3">
